...
type IssueQuery struct {
	...
	loadTotal []func(context.Context, []*Issue) error
...
func (iq *IssueQuery) QueryIssue() *TodoQuery {
	query := &TodoQuery{config: iq.config}
...
func (iq *IssueQuery) WithIssue(opts ...func(*TodoQuery)) *IssueQuery {
	query := &TodoQuery{config: iq.config}
...
func (iq *IssueQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Issue, error) {
	...
	if query := iq.withIssue; query != nil {
