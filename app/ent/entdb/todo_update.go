...
func (tu *TodoUpdate) SetDone(t time.Time) *TodoUpdate {
	tu.mutation.SetDone(t)
	return tu
}

// SetNillableDone sets the "done" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableDone(t *time.Time) *TodoUpdate {
	if t != nil {
		tu.SetDone(*t)
	}
	return tu
...
func (tu *TodoUpdate) check() error {
	if _, ok := tu.mutation.UserID(); tu.mutation.UserCleared() && !ok {
		return errors.New(`entdb: clearing a required unique edge "Todo.user"`)
	}
	return nil
}
...
// SetDone sets the "done" field.
func (tuo *TodoUpdateOne) SetDone(t time.Time) *TodoUpdateOne {
	tuo.mutation.SetDone(t)
	return tuo
}

// SetNillableDone sets the "done" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableDone(t *time.Time) *TodoUpdateOne {
	if t != nil {
		tuo.SetDone(*t)
	}
	return tuo
...
func (tuo *TodoUpdateOne) sqlSave(ctx context.Context) (_node *Todo, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`entdb: missing "Todo.id" for update`)}
	}
